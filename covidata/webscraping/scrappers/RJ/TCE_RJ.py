...
class TCE_RJ_Scraper(Scraper):
    def scrap(self):
        ...
        # Realiza o "parsing" do arquivo JSON para extração dos dados da tabela
        df = self.__esquadrinha_json(json)

        # Cria diretório do
        diretorio_rj = os.path.join(config.diretorio_dados, 'RJ')
        if not os.path.exists(diretorio_rj): os.makedirs(diretorio_rj)
    ...
    def __baixa_arquivo(self):
        ...
        url = config.url_tce_RJ

        # Cabeçalhos da requisção POST
        headers = {"Host": "wabi-brazil-south-api.analysis.windows.net", "Connection": "keep-alive",
                   "Content-Length": "5686", "Accept": "application/json, text/plain, */*",
                   "RequestId": "9df85402-7893-05d0-7d11-db4e62e17f73",
                   "X-PowerBI-ResourceKey": "9926f3ef-e5a3-4ae7-a300-3c0027b04e32",
                   "Content-Type": "application/json;charset=UTF-8",
                   "User-Agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/83.0.4103.97 Safari/537.36",
                   "ActivityId": "81bc4a2a-3f9c-485c-a7a2-9154c1a1e600", "Origin": "https://app.powerbi.com",
                   "Sec-Fetch-Site": "cross-site", "Sec-Fetch-Mode": "cors", "Sec-Fetch-Dest": "empty",
                   "Referer": "https://app.powerbi.com/view?r=eyJrIjoiOTkyNmYzZWYtZTVhMy00YWU3LWEzMDAtM2MwMDI3YjA0ZTMyIiwidCI6IjJjYmJlYmU0LTc2MzgtNDYxYi05ZjhjLTE2MmVkZGMzZDBlNCJ9",
                   "Accept-Encoding": "gzip, deflate, br",
                   "Accept-Language": "pt-BR,pt;q=0.9,en-US;q=0.8,en;q=0.7,de;q=0.6,it;q=0.5,fr;q=0.4,es;q=0.3"}
    ...
    def __esquadrinha_json(self, json):
        ...
        dados = json['results'][0]['result']['data']['dsr']['DS'][0]['PH'][0]['DM0']

        # Extrai o dicionário que mapeia valores numéricos para os respectivos textos (usado para compactação)
        value_dicts = json['results'][0]['result']['data']['dsr']['DS'][0]['ValueDicts']
        ...
        for registro_atual in dados[1::]:
            ...
            try:
                ...
                registro_atual_completo = self.__completa_registro(registro_anterior_completo, registro_atual_incompleto,
                                                              valor_r)
        ...
        colunas = ["Processo", "Objeto", "Afastamento", "Data Aprovação", "Enquadramento Legal", "Unidade",
                   "Fornecedor", "Qtd", "Valor Processo", "Unidade Medida", "Item", "Valor Unitário"]
        ...
        colunas_mapeadas = ["Processo", "Objeto", "Afastamento", "Enquadramento Legal", "Unidade", "Fornecedor", "Qtd",
                            "Unidade Medida", "Item"]
    ...
    def __completa_registro(self, registro_anterior, registro_atual, valor_r):
        """
        ...
        NUM_COLUNAS = 12
        assert (len(
            registro_anterior) == NUM_COLUNAS)  # O registro anterior precisa estar completo (i.e. ter os 12 valores)
    ...
    def consolidar(self, data_extracao):
        return self.__consolidar_compras_diretas(data_extracao), False
