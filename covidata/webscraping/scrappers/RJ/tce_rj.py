...
def main():
    ...
    df = __esquadrinha_json(json)

    # Cria diretório do
    diretorio_rj = os.path.join(diretorio_dados, 'RJ')
...
def __esquadrinha_json(json):
    ...
    for registro_atual in dados[1::]:
        ...
        try:
            ...
            registro_atual_completo = __completa_registro(registro_anterior_completo, registro_atual_incompleto, valor_r)
...
def __completa_registro(registro_anterior, registro_atual, valor_r):
    """
